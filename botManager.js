...
* Improved to distinguish between real rate limits and key rotation file errors.
*/
function switchToNextKey(error) {
 ...
 // File permission errors should NOT trigger cooldown
 const isFileError = 
 ...
 if (isRateLimit && !isFileError) {
   ...
   console.log(`📁 Key ${oldIdx + 1} skipped (file error, not rate limit)`);
 }
