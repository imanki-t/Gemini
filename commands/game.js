...
// Use lighter model for commands
...
export async function handleAkinatorAnswer(interaction) {
  ...
  // Check if it's individual mode and if the user is the starter
...
export async function handleNHIENext(interaction) {
  // Remove all reactions before generating new statement
  try {
...
export async function handleWYRVote(interaction) {
  ...
  // Remove user from other option if they voted there
...
export async function handleWYRNext(interaction) {
  ...
  // Show results for the previous round publicly
